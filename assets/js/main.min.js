...
Array.prototype.forEach.call(elements, function(e) {
    if (-1 !== e.type.indexOf("math/tex")) {
        ...
        t = t.replace(/%.*/g, "");
        var n = document.createElement("span"); - 1 !== e.type.indexOf("mode=display") ? (n.className += "math-display", t = "\\displaystyle {" + t + "}") : n.className += "math-inline", katex.render(t, n), e.parentNode.insertBefore(n, e)
    }
});
try {
...
document.addEventListener("DOMContentLoaded", function(e) {
    ...
    t.addEventListener("click", function(e) {
        ...
        320 < window.innerWidth && n.removeAttribute("style")
